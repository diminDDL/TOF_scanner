...
uint8_t EPROM_ReadIIC(EPROM* InstancePtr, uint8_t reg, uint8_t *Data, int nData);
uint8_t EPROM_WriteIIC(EPROM* InstancePtr, uint8_t reg, uint8_t *Data, int nData);
...
**
**	Return Value:
**	uint8_t	ERRVAL_EPROM_READ	- failed to read EEPROM over I2C communication
**	uint8_t	ERRVAL_SUCCESS		- success
**
**	Description:
**		Reads nData data bytes from the consecutive registers starting at the specified register address.
**
*/
uint8_t EPROM_ReadIIC(EPROM* InstancePtr, uint8_t addr, uint8_t *Data, int nData)
{
	int Status;
...
**
**	Return Value:
**	uint8_t	ERRVAL_EPROM_WRITE  - failed to write EEPROM over I2C communication
**	uint8_t	ERRVAL_SUCCESS		- success
**	Description:
**		Writes nData data bytes to the consecutive registers starting at the specified register address.
**
*/
uint8_t EPROM_WriteIIC(EPROM* InstancePtr, uint8_t addr, uint8_t *Data, int nData)
{
