...
*/
void ISL29501_begin(ISL29501* InstancePtr, u32 IIC_Address, uint8_t Chip_Address)
{
...
**
**	Return Value:
**	uint8_t	ERRVAL_ToF_READ - failed to read ISL29501 registers over I2C communication
...
**
*/
uint8_t ISL29501_ReadIIC(ISL29501* InstancePtr, uint8_t reg, uint8_t *Data, int nData)
{
	int Status;
	int Sent;
...
**
**	Return Value:
**	uint8_t	ERRVAL_ToF_WRITE - failed to write ISL29501 registers over I2C communication
**	uint8_t	ERRVAL_SUCCESS 	- success
**	Description:
**		Writes nData data bytes to the consecutive registers starting at the specified register address.
**
*/
uint8_t ISL29501_WriteIIC(ISL29501* InstancePtr, uint8_t reg, uint8_t *Data, int nData)
{
	uint8_t out[10];
	out[0]=reg;
//	out[1]=*Data;
